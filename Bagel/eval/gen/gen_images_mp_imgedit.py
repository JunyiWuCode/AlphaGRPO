...
if __name__ == "__main__":
    ...
    weight_path = os.environ.get('BAGEL_WEIGHT_PATH', None)
    ...
    prompts_per_gpu = len(idx_list)
    print(f"GPU {rank}: Processing {prompts_per_gpu} prompts")
    ...
    for i, idx in enumerate(idx_list):
        ...
        print(f"GPU {rank} processing prompt {i + 1}/{prompts_per_gpu}: '{prompt}'")
