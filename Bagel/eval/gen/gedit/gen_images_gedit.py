...
def setup_models(model_path, device=0):
    ...
    msg = model.load_state_dict(ema_state_dict, strict=False, assign=True)
    del ema_state_dict_path
...
def process_dataset(
    ...
    cfg_type="serial_text_img", num_samples=None,  use_think=False, device='cuda'
):
    """
    ...
    # dataset = load_from_disk("./data/-Bench")
    # print(dataset)
