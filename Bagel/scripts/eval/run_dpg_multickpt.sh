...
jobname=  # set up the subdir for your experiment job name
checkpoint_list=()  # set up checkpoint numbers to evaluate, e.g. (100 200 300)
resolution=1024  # generation resolution, 512 or 1024
...
do
    ...
    uv pip install addict simplejson sortedcontainers datasets==2.21.0
    cd $pwd_bench
    echo $pwd_bench
